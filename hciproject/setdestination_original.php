    ...
    <section id="location">
        <div class="container">
			...
			<!-- Put your map here -->
				...
				<input required type="text" class="form-control" name="location" id="search" value="<?php if (isset($_SESSION["destination"])){echo $_SESSION["destination"];echo '">';} else {echo '" placeholder="Search">';}?>
