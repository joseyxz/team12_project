            ...
            <div class="row text-center">
                <div>
                    ...
                    ?>           
                           ...
                           <input type="submit" class="btn btn-default btn-sm" value="GPS" ng-click="search('10 Dover Drive, Singapore 138683')" onMousedown="<?php $_SESSION["start"]= 'dover singapore' ?>"
                </div>
